...
const BUS_TYPES = [
  ...
  { value: 'Sleeper',      label: 'Non-AC Sleeper' },
  { value: 'Seater',       label: 'Non-AC Seater' },
...
export default function BusSearch({ initialValues = {}, onSearch }) {
  ...
  const [busType,     setBusType] = useState(initialValues.busType     || '')
    ...
    <div className="w-full">
      <div className="flex border border-gray-300 rounded-lg overflow-visible mb-4">
        ...
        <div className="flex-1 min-w-0 px-4 pt-3 pb-3 border-r border-gray-300 hover:bg-gray-50 transition-colors relative">
          ...
          <CitySearch large value={origin} onChange={setOrigin} placeholder="Departure City" required />
        </div>
        ...
        <div className="flex-1 min-w-0 px-4 pt-3 pb-3 border-r border-gray-300 hover:bg-gray-50 transition-colors relative">
          ...
          <CitySearch large value={destination} onChange={setDest} placeholder="Arrival City" required />
        </div>

        {/* DATE */}
        <div
          className="w-44 shrink-0 px-4 pt-3 pb-3 border-r border-gray-300 hover:bg-gray-50 transition-colors cursor-pointer select-none relative"
          onClick={openDate}>
        ...
        {/* BUS TYPE */}
        <div className="w-44 shrink-0 px-4 pt-3 pb-3 hover:bg-gray-50 transition-colors">
